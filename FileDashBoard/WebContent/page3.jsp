...
<%@page import="org.quinnox.pojo.GetFileList"%>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">List of files</h2>
						<%List<GetFileList> fileList;%>
							<% HttpSession session2 = request.getSession();
							   String dateTime = session2.getAttribute("dateTime").toString();
							   DashBoardDAO dashBoardDAO = new DashBoardDAO();
							   fileList = dashBoardDAO.getFileList(dateTime);
